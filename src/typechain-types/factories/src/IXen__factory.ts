...
import type { IXen, IXenInterface } from "../../src/IXen";
...
export class IXen__factory {
  static readonly abi = _abi;
  static createInterface(): IXenInterface {
    return new utils.Interface(_abi) as IXenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IXen {
    return new Contract(address, _abi, signerOrProvider) as IXen;
  }
}
